...
Card.config = function (config) {
    ...
    config.minThrowOutDistance = config.minThrowOutDistance ? config.minThrowOutDistance : 0;
    config.maxThrowOutDistance = config.maxThrowOutDistance ? config.maxThrowOutDistance : 200;
...
Card.isThrowOut = function (offset, elementWidth) {
    ...
    console.log(Card.throwOutConfidence(offset, (elementWidth/1.5)));
